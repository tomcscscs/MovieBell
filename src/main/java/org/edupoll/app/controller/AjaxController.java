...
public class AjaxController {
    ...
    @ResponseBody
    public Map<String, String> processPickController(@RequestBody PicksCommand cmd, Authentication authentication, Model model) {
        // Picks 객체 생성 및 저장
        Picks one = Picks.builder()
            .movieId(cmd.getMovieId())
            .originalTitle(cmd.getMovieTitle())
            .releaseDate(cmd.getTiming())
            .posterPath(cmd.getPosterPath())
